 ...
 */
final class Version20240324170550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire DROP product_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD product_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT FK_67F068BC4584665A FOREIGN KEY (product_id) REFERENCES produit (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
